...
def get_prices_and_formats
  ...
  filepath = '/Users/Laf1BUp/Dropbox/Documents/Noblessence/Noblessence_Ressources_Site_web/Data_votresite/To_import/products-stripped-vrac-bronners.csv'
  ...
  CSV.foreach(filepath) do |row|
    ...
    url = "http://www.noblessence.com/fr/produits/c378161808/c378161809/#{r}.html"
    ...
    begin
      ...
      if html_file
        ...
        vrac_bronners_name = html_doc.xpath('//*[@id="item_desc2"]/h2').children.text
...
def write_to_csv(data)
  file = '/Users/Laf1BUp/Dropbox/Documents/Noblessence/Noblessence_Ressources_Site_web/Data_votresite/To_import/vrac-bronners-data.csv'
