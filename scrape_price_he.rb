  ...
  CSV.foreach(filepath) do |row|
    ...
    begin
      ...
      if html_file
        ...
        he_name = html_doc.xpath('//*[@id="item_desc2"]/h2').children.text
...
def write_to_csv(data)
  file = '/Users/Laf1BUp/Dropbox/Documents/Noblessence/Noblessence_Ressources_Site_web/Data_votresite/To_import/he_data.csv'
